...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-sm px-8 py-14 mt-30 font-sans antialiased md:max-w-4xl md:px-12 lg:px-16 bg-green-800/50 rounded-3xl">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center border-green-700 border-2"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
